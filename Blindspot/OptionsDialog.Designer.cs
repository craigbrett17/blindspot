namespace Blindspot
{
    partial class OptionsDialog
    {
        ...
        private void InitializeComponent()
        {
			...
			this.skipUnplayableBox = new System.Windows.Forms.CheckBox();
			...
			this.generalPage.Controls.Add(this.skipUnplayableBox);
			...
			// skipUnplayableBox
			// 
			resources.ApplyResources(this.skipUnplayableBox, "skipUnplayableBox");
			this.skipUnplayableBox.Name = "skipUnplayableBox";
			this.skipUnplayableBox.UseVisualStyleBackColor = true;
			// 
			// deviceBox
			// 
		...
		private System.Windows.Forms.CheckBox skipUnplayableBox;
    }
}